    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="olah.php">Buat Laporan</a></li>
        </ul>
      </nav><!-- .navbar -->
    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div
          ...
          <h2 data-aos="fade-up">Layanan Aspirasi dan <br>Pengaduan Online Rakyat</h2>
        ...
        <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
          <img src="assets/img/layanan.jpg" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="300">
        </div>
      </div>
    </div>
            ...
            <div class="container mt-5">
              ...
              <form action="proses.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <textarea name="isi" id="isi" rows="6" class="form-control " placeholder="Ketik Isi Laporan Anda *"
                      required=""></textarea>
